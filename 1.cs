    ...
    class Program
    {
        ...
        public void manageServerMessage(string text)
        {
           ...
           // Match m = r.Match(text);
            ...
            //if (m.Success)
            //{
             //   move[0] = Convert.ToInt16(m.Groups[1]);
             //   move[1] = Convert.ToInt16(m.Groups[2]);
            //    move[2] = Convert.ToInt16(m.Groups[3]);
              //  move[3] = Convert.ToInt16(m.Groups[4]);
           // }
          ...
          //  }
           ...
           // if (m.Success)
           // {
           //     message = Convert.ToString(m.Groups[1]);
